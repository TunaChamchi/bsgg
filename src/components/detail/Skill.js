        ...
        return skill.slice(0, 5).map((name, idx) =>
            <div className='skill_td' key={'td'+idx}>
                <div className={'skill_tr skill_'+name} key={'tr'+idx} >
                    <img className="skill_img" key={'tree'+idx} src={'img/Skill/'+character+'/'+character+'_'+name+'.jpg'} />
                    <div className="S_skill_tooltip">
                            <span><b>{intl.formatMessage({id: 'skill.'+character+"."+name+".name"})}</b></span><br />
                            <span>{intl.formatMessage({id: 'skill.'+character+"."+name+".Detail"})}</span>
                    </div>
                </div>
